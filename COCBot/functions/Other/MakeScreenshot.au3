...
Func MakeScreenshot($TargetDir, $type = "jpg")
	...
	If WinGetAndroidHandle() <> 0 Then
	    ...
	    If $g_bScreenshotHideName Then
		 ...
		 _GDIPlus_GraphicsDrawString($hGraphic, "Stone: " & $g_aVillageSize[4] & ", " & $g_aVillageSize[5], 5, 10, "Arial", 12)
		 _GDIPlus_GraphicsDrawString($hGraphic, "Trees: " & $g_aVillageSize[7] & ", " & $g_aVillageSize[8], 5, 30, "Arial", 12)
