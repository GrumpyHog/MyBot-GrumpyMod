...
Func getRemainTrainTimer($x_start, $y_start, $bNeedCapture = True) ;
	Return getOcrAndCapture("coc-RemainTrain", $x_start, $y_start, 70, 14, True, False, $bNeedCapture)
...
Func getResourcesLootDE($x_start, $y_start) ; -> Gets complete value of Dark Elixir after attack xxx,xxx "AttackReport"
	Return getOcrAndCapture("coc-loot", $x_start, $y_start, 100, 22, True)
...
Func getArmyCampCap($x_start, $y_start, $bNeedCapture = True) ;  -> Gets army camp capacity --> train.au3, and used to read CC request time remaining
	Return getOcrAndCapture("coc-ms", $x_start, $y_start, 82, 20, True, False, $bNeedCapture)
...
Func getOcrGuardShield($x_start, $y_start) ;  -> Get the guard/shield time left, middle top of the screen ; full size 92, 26
	Return getOcrAndCapture("coc-guardshield", $x_start, $y_start, 92, 20)
...
Func getLeagueDayTimer($x_start, $y_start) ;  -> Get the time the Current League Day Ends
	Return getOcrAndCapture("coc-ld", $x_start, $y_start, 100, 30, True)
EndFunc   ;==>getLeagueDayTimer
