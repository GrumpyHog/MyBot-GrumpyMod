...
Func ImgLocateHeroAltar($sHero = 'BK')
	Switch $sHero
		case 'BK'
			Local $sImgDir = @ScriptDir & "\imgxml\Buildings\BKAltar\"
		case 'AQ'
			Local $sImgDir = @ScriptDir & "\imgxml\Buildings\AQAltar\"
		case 'GW'
			Local $sImgDir = @ScriptDir & "\imgxml\Buildings\GWAltar\"
		case 'RC'
			Local $sImgDir = @ScriptDir & "\imgxml\Buildings\RCAltar\"
	EndSwitch
