...
Func BotCommand()
	...
	SetLog("$g_iCurAccount :" & $g_iCurAccount)
	
	_Sleep(3000)

	If $g_bLaunchAttack[$g_iCurAccount] = False Then
	...
	If $bChkBotStop Then
		...
		Switch $iCmbBotCond
			...
			Case 23
				If $g_bAllLeagueAttacksMade Then $g_bMeetCondStop = True
