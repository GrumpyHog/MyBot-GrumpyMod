...
Func AttackReport()
	...
	$AtkLogTxt &= StringFormat("%1d", $g_iSidesAttack) & "|"
	...
	; Gold/Elixir League bonus 0 - 340,000 
	If $g_iStatsBonusLast[$eLootGold] > 99999 Then
		$AtkLogTxt &= StringFormat("%4d", ($g_iStatsBonusLast[$eLootGold]/1000)) & "k|"
		$AtkLogTxt &= StringFormat("%4d", ($g_iStatsBonusLast[$eLootElixir]/1000)) & "k|"
	Else
		$AtkLogTxt &= StringFormat("%5d|", $g_iStatsBonusLast[$eLootGold])
		$AtkLogTxt &= StringFormat("%5d|", $g_iStatsBonusLast[$eLootElixir])
	EndIf

	; DE League bonus 0 - 2400
