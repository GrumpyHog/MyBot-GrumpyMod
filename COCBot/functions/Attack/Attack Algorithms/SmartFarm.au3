...
Func DebugImageSmartFarm($THdetails, $aIn, $aOut, $sTime, $BestSideToAttack, $redline)
	...
	; - DRAW GetVillageSize
	;_GDIPlus_GraphicsDrawString($hGraphic, "S: " & $g_sVillageScenery, 5, 490, "Arial", 12)
	...
	_GDIPlus_GraphicsDrawLine($hGraphic, int($g_aVillageSize[4]), int($g_aVillageSize[5]), int($g_aVillageSize[7]), int($g_aVillageSize[8]), $hPen)	
