...
Func ReadConfig_600_6()
	...
	IniReadS($g_bChkClanGamesDebugImages, $g_sProfileConfigPath, "other", "ChkClanGamesDebugImages", False, "Bool")
...
Func ReadConfig_600_12()
	...
	$g_asTxtDonateTroop[$eTroopSuperDragon] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateSuperDragons", "Super Dragon|SDrag"), "|", @CRLF)
	...
	$g_asTxtDonateTroop[$eTroopCount + $g_iCustomDonateConfigs + $eSiegeLogLauncher] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateLogL", "Launcher|siege"), "|", @CRLF)
	$g_asTxtBlacklistTroop[$eTroopCount + $g_iCustomDonateConfigs + $eSiegeLogLauncher] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtBlacklistLogL", "no Log|siege no"), "|", @CRLF)


	$g_asTxtDonateTroop[$eTroopCount + $g_iCustomDonateConfigs + $eSiegeFlameFlinger] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateFlameF", "Flame|siege"), "|", @CRLF)
	$g_asTxtBlacklistTroop[$eTroopCount + $g_iCustomDonateConfigs + $eSiegeFlameFlinger] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtBlacklistFlameF", "no Flame|siege no"), "|", @CRLF)
...
Func ReadConfig_600_52_2()
   ...
   ; set ArmyComp to ArmyCustom or ArmyQuick
   ...
   If $g_bUseCustomSiegeMachines = True Then
	  $g_aiArmyCompSiegeMachines = $g_aiArmyCustomSiegeMachines
   Else
	  $g_aiArmyCompSiegeMachines = $g_bQuickTrainEnable ? $g_aiArmyQuickSiegeMachines : $g_aiArmyCustomSiegeMachines
   EndIf
