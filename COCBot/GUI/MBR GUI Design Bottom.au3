...
Func CreateBottomPanel()
	...
	;GUISetBkColor (0x00008B)
		...
		$g_hChkBackgroundMode = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Bottom", "ChkBackgroundMode", "BG Mode"), $x + 1, $y + 72, 115, 24)
			GUICtrlSetFont(-1, 7)
		...
		$g_hLblVersion = GUICtrlCreateLabel($g_sBotVersion, $x + 155, $y + 77, 60, 17, $SS_LEFT ) ; x + 120
